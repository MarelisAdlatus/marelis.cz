...
<p class="fs-5">This project was born out of curiosity if anyone else would be interested in how something is created in the RS DesignSpark Mechanical editor.</p>
        ...
        <div class="carousel-inner">
            ...
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/01-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item active" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Instructions for installing and setting up the RS DesignSpark Mechanical 3D editor version 5.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/02-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Introduction to the RS DesignSpark Mechanical 3D editor.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/03-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>03. Box</h5>
                        <p>Creating a simple box in the RS DesignSpark Mechanical 3D editor.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/04-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Creating a simple hook in the RS DesignSpark Mechanical 3D editor.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/05-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Creating a house in the 3D editor RS DesignSpark Mechanical.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/06-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>06. Screwing</h5>
                        <p>Creating a threaded bolt and nut in the RS DesignSpark Mechanical 3D editor.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/07-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>07. Clutch</h5>
                        <p>Creating a coupling between bodies in the 3D editor RS DesignSpark Mechanical.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/08-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>Instructions for installing RS DesignSpark Mechanical 3D editor later version 6.</p>
                    </div>
                </div>
            </a>
            <!-- Item -->
            <a href="{{ url('storage/content/project/videotutorial-rs-designspark-mechanical/v1/09-foto.png') }}" class="glightbox" data-gallery="about">
                <div class="carousel-item" data-bs-interval="3000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>09. Text</h5>
                        <p>Transferring text to the body surface in the 3D editor RS DesignSpark Mechanical.</p>
                    </div>
                </div>
            </a>
        </div>
...
<p class="fs-5">I learned how to record video and audio, how to edit it and publish it on YouTube. I don't post regularly as I am busy with many other activities, but some ideas are still coming and hopefully they will become real.</p>
