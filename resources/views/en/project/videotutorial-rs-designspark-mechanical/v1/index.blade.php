...
<span class="navbar-text fs-5">Video tutorial RS DesignSpark Mechanical</span>
@endsection
            ...
            <div class="sticky-top" style="top: 5rem;">
                ...
                <div class="list-group list-group-flush fs-5">
                    ...
                    <a href="#cooperation" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Cooperation</div></div>
                    </a>
                    <a href="#resources" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Resources</div></div>
                    </a>
