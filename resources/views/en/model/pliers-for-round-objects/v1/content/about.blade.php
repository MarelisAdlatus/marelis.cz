...
<p class="fs-5">The inspiration for this project was the need for a painter who was straining her hands while holding a Christmas bulb while painting. The pliers are also suitable for holding other cylindrical objects, such as batteries, light bulbs, etc.</p>
            ...
            <div class="col mb-4">
                <div class="card" style="width: 24rem;">
                    <div class="border bg-secondary bg-opacity-25 m-2">
                        <model-viewer src="{{ asset('storage/content/model/pliers-for-round-objects/v1/pliers-for-round-objects.glb') }}"
                    ...
                    <div class="card-body">
                        <p class="card-text fs-5">
                            <strong>Pliers for round objects</strong><br/>
...
<p class="fs-5">I offer this model for free download on this page below or on the
    <a class="external-link link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" name="Cults" lang="en" href="https://cults3d.com/en/3d-model/tool/pliers-for-round-objects">Cults</a> website.
    The original project from the RS DesignSpark Mechanical editor is also available for download on this page.</p>
