...
<li class="nav-item"><a class="nav-link active-link fs-5" href="#projects">Project</a></li>
<li class="nav-item"><a class="nav-link active-link fs-5" href="#contact">Contact</a></li>
@endsection
        ...
        <div class="col-sm-3">
            ...
            <div>
                ...
                <div style="font-size: 34px;">
                    <a class="external-link" lang="en" id="github-link" name="GitHub" href="https://github.com" data-bs-toggle="tooltip" title="GitHub"><i class="bi bi-github" style="color: #000000;"></i></a>
                    <a class="external-link" lang="en" id="youtube-link" name="YouTube" href="https://www.youtube.com" data-bs-toggle="tooltip" title="YouTube"><i class="bi bi-youtube" style="color: #dc3545;"></i></a>
                    <a class="external-link" lang="en" id="discord-link" name="Discord" href="https://discord.com" data-bs-toggle="tooltip" title="Discord"><i class="bi bi-discord" style="color: #5865f2;"></i></a>
                    <a class="external-link" lang="en" id="steam-link" name="Steam" href="https://steamcommunity.com" data-bs-toggle="tooltip" title="Steam"><i class="bi bi-steam" style="color: #000000;"></i></a>
                    <a class="external-link" lang="en" id="facebook-link" name="Facebook" href="https://www.facebook.com" data-bs-toggle="tooltip" title="Facebook"><i class="bi bi-facebook" style="color: #0165e1;"></i></a>
                </div>
                <h3 class="mt-2">Contribute</h3>
                <p class="fs-5">Lorem ipsum dolor sit ame.</p>
                <a class="external-link text-decoration-none" lang="en" id="paypal-link" name="PayPal" href="https://www.paypal.com" data-bs-toggle="tooltip" title="PayPal">
                ...
                <a class="external-link text-decoration-none" lang="en" id="revolut-link" name="Revolut" href="https://www.revolut.com" data-bs-toggle="tooltip" title="Revolut">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form class="row g-3" method="POST" id="contact-form" autocomplete="on" lang="en">
                    @csrf
                    <div class="col-12">
