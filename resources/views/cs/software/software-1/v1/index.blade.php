            ...
            <div class="sticky-top" style="top: 5rem;">
                ...
                <div class="list-group list-group-flush">
                    <a href="#about" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>O softwaru</div></div>
                    </a>
                    <a href="#feature" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Vlastnosti</div></div>
                    </a>
                    ...
                    <a href="#install" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Instalace</div></div>
                    </a>
                    <a href="#usage" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Používání</div></div>
                    </a>
