<h3 id="related" class="border-bottom border-secondary border-1">Související</h3>
...
<div class="container">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
        <!-- Previews -->
        @include('cs.software.software-1.v1.preview')
        @include('cs.hardware.hardware-1.v1.preview')
        @include('cs.model.model-1.v1.preview')
    </div>
</div>
