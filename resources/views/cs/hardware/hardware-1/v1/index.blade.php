...
<span class="navbar-text fs-5">Hardware-1</span>
@endsection
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-10">
            ...
            @include($path . '.content.diagram')
            @include($path . '.content.circuit-board')
            @include($path . '.content.parts')
            ...
            <div class="sticky-top" style="top: 5rem;">
                ...
                <div class="list-group list-group-flush">
                    <a href="#about" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>O hardwaru</div></div>
                    </a>
                    ...
                    <a href="#diagram" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Schéma zapojení</div></div>
                    </a>
                    <a href="#circuit-board" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Obvodová deska</div></div>
                    </a>
                    <a href="#parts" class="list-group-item list-group-item-action list-group-item-light">
                        <div class="d-flex align-items-center fs-6"><i class="bi bi-record-fill text-primary opacity-75 pe-2"></i><div>Díly</div></div>
                    </a>
